...
class WeatherRequestLocation(private val api: ApiWeatherService) : WeatherServiceLocation {
    override fun getServiceWeatherLocation(latitude: Double, longitude: Double): Single<Weather> {
